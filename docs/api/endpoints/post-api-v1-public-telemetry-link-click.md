---
id: post-api-v1-public-telemetry-link-click
method: POST
path: /api/v1/public/telemetry/link-click
...
updated: 2026-09-24        # YYYY-MM-DD, the day the behaviour was last proven
---

# `POST /api/v1/public/telemetry/link-click`
...
curl -sS -w '\nHTTP %{http_code} in %{time_total}s\n' \
  -X POST "http://localhost:PORT/api/v1/public/telemetry/link-click"
```
