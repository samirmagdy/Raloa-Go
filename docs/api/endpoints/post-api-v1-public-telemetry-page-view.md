---
id: post-api-v1-public-telemetry-page-view
method: POST
path: /api/v1/public/telemetry/page-view
...
# `POST /api/v1/public/telemetry/page-view`
...
curl -sS -w '\nHTTP %{http_code} in %{time_total}s\n' \
  -X POST "http://localhost:PORT/api/v1/public/telemetry/page-view"
```
